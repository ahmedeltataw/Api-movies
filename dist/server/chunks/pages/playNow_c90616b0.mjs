import { d as createAstro, e as createComponent, r as renderTemplate, m as maybeRenderHead, h as renderComponent, g as addAttribute, i as renderHead, j as renderSlot, F as Fragment } from '../astro_7807166c.mjs';
import 'html-escaper';
import 'clsx';
import { $ as $$Image } from './node_0ffd187a.mjs';
/* empty css                            */
...
const $$SideMenu = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${maybeRenderHead()}<aside class="side-menu " data-astro-cid-h6j53edt><div class="container" data-astro-cid-h6j53edt><div class="side-list px-9" data-astro-cid-h6j53edt><p class="title-side fs-r-24 fw-700 pb-7" data-astro-cid-h6j53edt> genres</p><ul class="link-side" data-astro-cid-h6j53edt>${dataList.genres.map((li) => renderTemplate`<li data-astro-cid-h6j53edt><a href="/movie-List"${addAttribute(li.id, "id")} class="fs-r-16 items-link" data-astro-cid-h6j53edt>${li.name}</a></li>`)}</ul></div><div class="side-list px-9  " data-astro-cid-h6j53edt><p class="title-side fs-r-24 fw-700 pb-7" data-astro-cid-h6j53edt> follow us</p><ul class="link-side last-link" data-astro-cid-h6j53edt><li data-astro-cid-h6j53edt><a href="#!" class="fs-r-16 " data-astro-cid-h6j53edt><i class="bi bi-facebook pr-2" data-astro-cid-h6j53edt></i>
facebook
